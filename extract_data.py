...
import time
import io
import traceback # Thư viện này để in chi tiết lỗi
...
def update_file_securely():
    try:
        ...
        content_response.raise_for_status() # Bẫy lỗi HTTP
        ...
        for attempt in range(5):
            ...
            if upload.status_code in [200, 201]:
                ...
                print(f"Thử lại lần {attempt+1}, mã lỗi: {upload.status_code}, nội dung: {upload.text}")
                time.sleep(30)
                
    except Exception as e:
        print("--- ĐÃ XẢY RA LỖI CHI TIẾT ---")
        traceback.print_exc() # In chi tiết lỗi ra log
        exit(1)
